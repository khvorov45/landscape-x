...
int tbfast_main(aln_String* strings, int32_t stringsCount, void* out, int32_t outBytes, int argc, char* argv[]);
...
main() {
    ...
    tbfast_main((aln_String*)genSeq.seqs, genSeq.seqCount, outBuf, outBytes, arrlen(tbfastArgs), (char**)tbfastArgs);
