...
static void
makeequivdouble_tmalign(double* d, char* c, int n) {
    double  tmpd;
    double* dbk;
    int     tmpi;
    char    s;
...
static void
makeequivdouble_threshold(double* d, char* c, int n) {
    double  tmpd;
    double* dbk;
    int     tmpi;
    dbk = d;
...
static void
readtmalign(FILE* fp, char* seq1, char* seq2, double* equiv) {
    ...
    while (1) {
        ...
        if (!strncmp(line + 5, "denotes the residue pairs", 20))
            break;
    }
...
static void
readrash(FILE* fp, char* seq1, char* seq2, double* equiv) {
    char         line[1000];
    static char* equivchar = NULL;
    int          n;
...
static double
calltmalign(char** mseq1, char** mseq2, double* equiv, char* fname1, char* chain1, char* fname2, char* chain2, int alloclen) {
    FILE*       fp;
    int         res;
...
static double
callrash(int mem1, int mem2, char** mseq1, char** mseq2, double* equiv, char* fname1, char* fname2, int alloclen) {
    FILE* fp;
    //	int res;
    static char com[10000];
    double      value;
...
static void
preparetmalign(FILE* fp, char*** strfiles, char*** chainids, char*** seqpt, char*** mseq1pt, char*** mseq2pt, double** equivpt, int* alloclenpt) {
    int   i, res;
    char* dumseq;
    char  line[1000];
    char  fname[1000];
...
static void
prepareash(FILE* fp, char* inputfile, char*** strfiles, char*** chainids, char*** seqpt, char*** mseq1pt, char*** mseq2pt, double** equivpt, int* alloclenpt) {
    int   i, res;
    char* dumseq;
    char  line[1000];
    char  fname[1000];
...
static void
pairalign(char** name, int nlen[M], char** seq, char** aseq, char** mseq1, char** mseq2, double* equiv, double* effarr, char** strfiles, char** chainids, int alloclen) {
    int             i, j, ilim;
    int             clus1, clus2;
    int             off1, off2;
