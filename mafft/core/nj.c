...
void
topolcpy(int s1[], int s2[], int* mpt1, int* mpt2) {
    int i;
...
void
topolcat(int s1[], int s2[], int* mpt1, int* mpt2) {
    int i;
...
void
topolswap(int s1[], int s2[], int* mpt1, int* mpt2) {
    int i;
    int im;
    int b;
    b = *mpt1;
...
void
reduc(double** mtx, int nseq, int im, int jm) {
    int i;
    for (i = 0; i < nseq; i++) {
        if (i == im || i == jm
            ...
            continue;
        mtx[MIN(i, im)][MAX(i, im)] = 0.5 * (mtx[MIN(i, im)][MAX(i, im)] + mtx[MIN(i, jm)][MAX(i, jm)] - mtx[MIN(im, jm)][MAX(im, jm)]);
        mtx[MIN(i, jm)][MAX(i, jm)] = 9999.9;
    }
...
void
nj(int nseq, double** omtx, int*** topol, double** dis) {
    int    i, j, l, n, m;
    int    count;
    double r[M];
    double t;
