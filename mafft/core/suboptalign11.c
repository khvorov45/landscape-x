...
static int
compshuryo(Shuryoten* s1_arg, Shuryoten* s2_arg) {
...
static double
gentracking(int** used, char** seq1, char** seq2, char** mseq1, char** mseq2, double** cpmx1, double** cpmx2, int** ijpi, int** ijpj, int* off1pt, int* off2pt, int endi, int endj) {
...
double
suboptalign11(char** seq1, char** seq2, int alloclen, int* off1pt, int* off2pt, LocalHom* lhmpt)
