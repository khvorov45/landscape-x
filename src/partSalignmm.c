...
static void
part_imp_match_out_vead_gapmap(double* imp, int i1, int lgth2, int start2, int* gapmap2) {
#if FASTMACHCALC
    double* pt = imp;
...
static void
part_imp_match_out_vead_tate_gapmap(double* imp, int j1, int lgth1, int start1, int* gapmap1) {
#if FASTMACHCALC
    double* pt = imp;
...
void
part_imp_rna(int nseq1, int nseq2, char** seq1, char** seq2, double* eff1, double* eff2, RNApair*** grouprna1, RNApair*** grouprna2) {
...
/* score no keisan no sai motokaraaru gap no atukai ni mondai ga aru */
{
    ...
    if (seq1 == NULL) {
        if (orlgth1) {
            ...
            part_imp_match_init_strict(0, 0, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
double
partA__align_variousdist(int** which, double*** matrices, char** seq1, char** seq2, double* eff1, double* eff2, double** eff1s, double** eff2s, int icyc, int jcyc, int alloclen, int constraint, double* impmatch, int start1, int start2, int* gapmap1, int* gapmap2, char* sgap1, char* sgap2, char* egap1, char* egap2) {
    //	int k;
    register int i, j, c;
    int          lasti, lastj; /* outgap == 0 -> lgth1, outgap == 1 -> lgth1+1 */
    int          lgth1, lgth2;
