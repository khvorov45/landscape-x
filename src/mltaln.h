...
extern void      calcimportance_half(aln_Opts opts, int nseq, double* eff, char** seq, LocalHom** localhom, int alloclen);
...
extern void   gapireru(aln_Opts opts, char* res, char* ori, char* gt);
