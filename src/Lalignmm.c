...
static void
match_ribosum(double* match, double** cpmx1, double** cpmx2, int i1, int lgth2, double** doublework, int** intwork, int initialize) {
    int      j, k, l;
    double   scarr[38];
...
static double
MSalign2m2m_rec(int icyc, int jcyc, char** seq1, double** cpmx1, double** cpmx2, int ist, int ien, int jst, int jen, char** mseq1, char** mseq2, double** gapinfo, double** map)
...
/* score no keisan no sai motokaraaru gap no atukai ni mondai ga aru */
{
    ...
    wm = MSalign2m2m_rec(icyc, jcyc, seq1, cpmx1, cpmx2, 0, lgth1 - 1, 0, lgth2 - 1, mseq1, mseq2, gapinfo, map);
#if DEBUG
    fprintf(stderr, " seq1[0] = %s\n", seq1[0]);
    fprintf(stderr, " seq2[0] = %s\n", seq2[0]);
    fprintf(stderr, "mseq1[0] = %s\n", mseq1[0]);
